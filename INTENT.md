...
The intent is that this software and documentation ("Posh-Stig") should be treated as if it is licensed under the license associated with the Project ("MIT") in the LICENSE.md file. However, because we are part of the United States (U.S.) Federal Government, it is not that simple.
